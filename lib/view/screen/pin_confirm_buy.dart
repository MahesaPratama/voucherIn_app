...
class PinConfirmBuyPage extends StatefulWidget {
  const PinConfirmBuyPage({super.key});

  @override
  State<PinConfirmBuyPage> createState() => _PinConfirmBuyPageState();
}

class _PinConfirmBuyPageState extends State<PinConfirmBuyPage> {
  String _pin = "";
